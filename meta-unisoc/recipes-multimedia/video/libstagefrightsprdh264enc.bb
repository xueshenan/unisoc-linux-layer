DESCRIPTION = "Unisoc omx components h264 hw encoder"
...
PV = "0.1"
PR = "r0"
PROVIDES = "libstagefrightsprdh264enc"
...
do_install () {
    install -d ${D}${libdir}/
    install -m 0777 ${B}/libstagefright_sprd_h264enc.so ${D}${libdir}/
}

FILES_${PN} += "${libdir}/libstagefright_sprd_h264enc.so"
FILES_SOLIBSDEV = ""
