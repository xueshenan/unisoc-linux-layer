DESCRIPTION = "Unisoc codecs demo hevc decoder"
...
do_install () {
    install -d ${D}${bindir}/
    install -m 0777 ${B}/utest_vsp_hevch265dec ${D}${bindir}/
}

FILES_${PN} += "${bindir}/utest_vsp_hevch265dec"
