DESCRIPTION = "Unisoc omx components vp9 hw encoder"
...
PV = "0.1"
PR = "r0"
PROVIDES = "libstagefrightsprdvp9enc"
...
do_install () {
    install -d ${D}${libdir}/
    install -m 0777 ${B}/libstagefright_sprd_vp9enc.so ${D}${libdir}/
}

FILES_${PN} += "${libdir}/libstagefright_sprd_vp9enc.so"
FILES_SOLIBSDEV = ""
