DESCRIPTION = "Unisoc omx components h265 hw decoder"
...
PV = "0.1"
PR = "r0"
PROVIDES = "libstagefrightsprdh265dec"
...
do_install () {
    install -d ${D}${libdir}/
    install -m 0777 ${B}/libstagefright_sprd_h265dec.so ${D}${libdir}/
}

FILES_${PN} += "${libdir}/libstagefright_sprd_h265dec.so"
FILES_SOLIBSDEV = ""
