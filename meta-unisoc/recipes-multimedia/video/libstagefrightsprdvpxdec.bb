DESCRIPTION = "Unisoc omx components vp8 hw decoder"
...
PV = "0.1"
PR = "r0"
PROVIDES = "libstagefrightsprdvpxdec"
...
do_install () {
    install -d ${D}${libdir}/
    install -m 0777 ${B}/libstagefright_sprd_vpxdec.so ${D}${libdir}/
}

FILES_${PN} += "${libdir}/libstagefright_sprd_vpxdec.so"
FILES_SOLIBSDEV = ""
