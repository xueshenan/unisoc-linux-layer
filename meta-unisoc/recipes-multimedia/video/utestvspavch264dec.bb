DESCRIPTION = "Unisoc codecs demo avc decoder"
...
do_install () {
    install -d ${D}${bindir}/
    install -m 0777 ${B}/utest_vsp_avch264dec ${D}${bindir}/
}

FILES_${PN} += "${bindir}/utest_vsp_avch264dec"
