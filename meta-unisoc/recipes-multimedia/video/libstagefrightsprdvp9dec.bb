DESCRIPTION = "Unisoc omx components vp9 hw decoder"
...
PV = "0.1"
PR = "r0"
PROVIDES = "libstagefrightsprdvp9dec"
...
do_install () {
    install -d ${D}${libdir}/
    install -m 0777 ${B}/libstagefright_sprd_vp9dec.so ${D}${libdir}/
}

FILES_${PN} += "${libdir}/libstagefright_sprd_vp9dec.so"
FILES_SOLIBSDEV = ""
