DESCRIPTION = "Unisoc omx components mpeg4 hw encoder"
...
PV = "0.1"
PR = "r0"
PROVIDES = "libstagefrightsprdmpeg4enc"
...
do_install () {
    install -d ${D}${libdir}/
    install -m 0777 ${B}/libstagefright_sprd_mpeg4enc.so ${D}${libdir}/
}

FILES_${PN} += "${libdir}/libstagefright_sprd_mpeg4enc.so"
FILES_SOLIBSDEV = ""
