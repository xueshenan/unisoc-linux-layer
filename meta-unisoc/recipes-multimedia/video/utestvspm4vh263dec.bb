DESCRIPTION = "Unisoc codecs demo MPEG4/H263 decoder"
...
do_install () {
    install -d ${D}${bindir}/
    install -m 0777 ${B}/utest_vsp_m4vh263dec ${D}${bindir}/
}

FILES_${PN} += "${bindir}/utest_vsp_m4vh263dec"
