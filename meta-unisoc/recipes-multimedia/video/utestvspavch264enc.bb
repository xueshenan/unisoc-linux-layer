DESCRIPTION = "Unisoc codecs demo avc encoder"
...
do_install () {
    install -d ${D}${bindir}/
    install -m 0777 ${B}/utest_vsp_avch264enc ${D}${bindir}/
}

FILES_${PN} += "${bindir}/utest_vsp_avch264enc"
