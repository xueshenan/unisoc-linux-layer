SUMMARY = "ARM Mali-Natt GPU User Mode Drivers"
LICENSE = "CLOSED"
PV = "r32"
PR = "p0"
...
SRC_URI = "ssh://gitadmin@gitmirror.unisoc.com/yocto/unisoc/gpu;protocol=ssh;branch=unc_linux_trunk_2.0"
...
do_install () {
    ...
    ln -sf libmali.so.0.32.0 libmali.so.0
    ...
    ln -sf libOpenCL.so.2.1.0 libOpenCL.so.2
    ln -sf libOpenCL.so.2 libOpenCL.so
}

# auto package into rootfs
FILES_${PN} += "${libdir}/* ${includedir}/*"

# avoid ERROR for "libnatt was already stripped".
INSANE_SKIP_${PN} = "already-stripped"

# avoid ERROR for "No GNU_HASH in the elf binary"
