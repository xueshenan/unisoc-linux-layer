...
EXTERNALSRC = "${OEROOT}/source/unisoc/perflink/netcon/echoclient"
EXTERNALSRC_BUILD = "${OEROOT}/source/unisoc/perflink/netcon/echoclient"

SRC_URI = " \
    ssh://gitadmin@gitmirror.unisoc.com/yocto/unisoc/netcon/echoclient;protocol=ssh;branch=unc_linux_trunk \
...
do_install () {
    install -d ${D}${bindir}/
    install -m 0755 ${S}/../out/bin/echoclient ${D}${bindir}/
